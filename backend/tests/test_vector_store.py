...
class TestVectorStore:
    ...
    def test_search_with_no_filters(
        self, temp_vector_store, sample_course, sample_course_chunks
    ):
    ...
    def test_search_with_nonexistent_course(
        ...
        results = vs.search(
            "machine learning", course_name="Cooking and Baking Masterclass"
        )
    ...
    def test_search_with_both_filters(
        ...
        results = vs.search(
            "linear regression", course_name="Machine Learning", lesson_number=3
        )
...
class TestVectorStoreWithMaxResultsZero:
    ...
    def test_search_returns_empty_with_zero_max_results(
        self, zero_results_store, sample_course, sample_course_chunks
    ):
    ...
    def test_search_with_explicit_limit_overrides_zero(
        self, zero_results_store, sample_course, sample_course_chunks
    ):
