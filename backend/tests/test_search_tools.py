...
class TestCourseSearchTool:
    ...
    def test_format_results_with_lesson_links(self, mock_vector_store, sample_search_results):
        ...
        mock_vector_store.get_lesson_link.assert_any_call("Introduction to Machine Learning", 1)
        mock_vector_store.get_lesson_link.assert_any_call("Introduction to Machine Learning", 2)
...
class TestCourseOutlineTool:
    ...
    def test_execute_successful_outline(self, mock_vector_store, sample_course):
        ...
        course_metadata = {
            ...
            "lessons": [
                {"lesson_number": 1, "lesson_title": "What is Machine Learning?", "lesson_link": "https://example.com/lesson1"},
                {"lesson_number": 2, "lesson_title": "Data Preprocessing", "lesson_link": "https://example.com/lesson2"}
            ]
        }
        ...
        assert tool.last_sources[0]["text"] == "Introduction to Machine Learning - Course Outline"
