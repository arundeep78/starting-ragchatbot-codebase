...
"""
    ...
    def test_add_course_document_success(self, test_config_with_chroma, sample_document_content):
        ...
        try:
            ...
            assert course.lessons[0].lesson_link == "https://example.com/ml-course/lesson1"
            
        finally:
            os.unlink(temp_file_path)
    
    def test_add_course_folder_success(self, test_config_with_chroma, sample_document_content):
    ...
    def test_add_course_folder_skip_existing(self, test_config_with_chroma, sample_document_content):
    ...
    def test_query_without_tools(self, mock_anthropic, test_config_with_chroma):
        ...
        mock_response.content[0].text = "This is a general response about machine learning concepts."
    ...
    @patch('ai_generator.anthropic')
    def test_query_with_tool_use(self, mock_anthropic, test_config_with_chroma, sample_document_content):
        ...
        final_response.content[0].text = "Based on the course materials, machine learning is a method of data analysis that automates model building."
...
class TestRAGSystemWithRealVectorStore:
    ...
    def test_vector_store_search_with_real_data(self, rag_with_real_db, sample_document_content):
...
class TestRAGSystemErrorScenarios:
    ...
    def test_api_error_handling(self, mock_anthropic, test_config_with_chroma):
        ...
        assert "An error occurred during tool execution: API connection failed" in response
        assert sources == []
