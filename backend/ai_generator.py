...
"""
        ...
        for round_num in range(1, max_rounds + 1):
            try:
                response = self._execute_round(
                    round_state, tools, system_content, round_num
                )
                ...
                tool_success = self._process_tool_execution_for_round(
                    response, round_state, tool_manager, round_num
                )
    ...
    def _process_tool_execution_for_round(
        self, response, round_state: ToolRoundState, tool_manager, round_num: int
    ) -> bool:
    ...
    def _generate_final_response_after_tools(
        self, round_state: ToolRoundState, system_content: str
    ) -> str:
